            ...
            <div class="col-lg-12" data-aos="fade-down">
                <div class="listing-tabs-group">
                    <ul class="nav listing-buttons gap-3" data-bs-tabs="tabs">
                        <li>
                            <a class="active" aria-current="true" data-bs-toggle="tab" href="#particulier">
                                Particulier
                            </a>
                        </li>
                        <li>
                            <a data-bs-toggle="tab" href="#entreprise">
                                Entreprise
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="login-wrapper">
                        <div class="loginbox">
                            <div class="login-auth">
                                <div class="login-auth-wrap">
                                    ...
                                    <h1>S'inscrire avec un compte particulier</h1>
                        ...
                        <div class="form-group content-div" id="div_date_passport">
                            ...
                            @enderror
                                        ...
                                        <input type="hidden" name="type_user" value="particulier">
                        ...
                        <div class="loginbox">
                            <div class="login-auth">
                                <div class="login-auth-wrap">
                                    ...
                                    <h1>S'inscrire avec un compte entreprise</h1>
                                    <p class="account-subtitle">
                                        Nous vous enverrons un code de confirmation à votre adresse e-mail.
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label">Boite postale <span class="text-danger">*</span></label>
                                            <input id="boite_postale" type="text" class="form-control @error('boite_postale') is-invalid @enderror" name="boite_postale" value="{{ old('boite_postale') }}" required autocomplete="Boite postale" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="niu" type="text" class="form-control @error('niu') is-invalid @enderror" name="niu" value="{{ old('niu') }}" required autocomplete="NIU" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="siren" type="text" class="form-control @error('siren') is-invalid @enderror" name="siren" value="{{ old('siren') }}" required autocomplete="SIREN" />
                                        ...
                                        <input type="hidden" name="type_user" value="entreprise">
                                        <button type="submit" class="btn btn-outline-light w-100 btn-size mt-1">S'inscrire</button>
