        ...
        <div class="content">
            ...
            <div class="row" style="margin-top: 100px;">
                ...
                <div class="col-6 text-end">
                    <p>
                        Nom de l'entreprise : {{$bon_livraison->commandes->users->name}}
                    </p>
                    <p>
                        Adresse : {{$bon_livraison->commandes->users->adresse}}
                    </p>
                    <p>
                        BP {{$bon_livraison->commandes->users->boite_postale}} TEL: {{$bon_livraison->commandes->users->tel}}
                    </p>
                    <p>
                        SIRET: {{$bon_livraison->commandes->users->siret}}
                    </p>
                    <p>
                        SIREN: {{$bon_livraison->commandes->users->siren}}
                    </p>
                </div>
            </div>
