    ...
    <div class="table-section bill-tbl w-100 mt-10">
        <table class="table w-100 mt-10">
            ...
            <tr>
                ...
                <td>
                    <div class="box-text">
                        <p>Nom de l'entreprise : {{$facture->commande_maintenance->users->name}}</p>
                        <p>BP: {{$facture->commande_maintenance->users->boite_postale}}</p>
                        <p>Adresse : {{$facture->commande_maintenance->users->adresse}}</p>
                        <p>Email : {{$facture->commande_maintenance->users->email}}</p>
                        <p>Tel : {{$facture->commande_maintenance->users->tel}}</p>
                        <p>SIRET : {{$facture->commande_maintenance->users->siret}}</p>
                        <p>SIREN : {{$facture->commande_maintenance->users->siren}}</p>
                    </div>
                </td>
            </tr>
        </table>
