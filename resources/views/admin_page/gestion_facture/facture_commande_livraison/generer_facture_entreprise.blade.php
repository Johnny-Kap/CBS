    ...
    <div class="table-section bill-tbl w-100 mt-10">
        <table class="table w-100 mt-10">
            ...
            <tr>
                ...
                <td>
                    <div class="box-text">
                        <p>Nom de l'entreprise : {{$facture->livraisons->users->name}}</p>
                        <p>BP: {{$facture->livraisons->users->boite_postale}}</p>
                        <p>Adresse : {{$facture->livraisons->users->adresse}}</p>
                        <p>Email : {{$facture->livraisons->users->email}}</p>
                        <p>Tel : {{$facture->livraisons->users->tel}}</p>
                        <p>SIRET : {{$facture->livraisons->users->siret}}</p>
                        <p>SIREN : {{$facture->livraisons->users->siren}}</p>
                    </div>
                </td>
            </tr>
        </table>
