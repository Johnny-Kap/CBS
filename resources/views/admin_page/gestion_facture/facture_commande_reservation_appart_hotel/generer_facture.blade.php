    ...
    <div class="table-section bill-tbl w-100 mt-10">
        <table class="table w-100 mt-10">
            ...
            <tr>
                ...
                <td>
                    <div class="box-text">
                        <p>Nom(s) : {{$facture->reservations_appart_hotel->users->name}}</p>
                        <p>Prénom(s): {{$facture->reservations_appart_hotel->users->prenom}}</p>
                        <p>Adresse : {{$facture->reservations_appart_hotel->users->adresse}}</p>
                        <p>Email : {{$facture->reservations_appart_hotel->users->email}}</p>
                        <p>Contact : {{$facture->reservations_appart_hotel->users->tel}}</p>
                    </div>
                </td>
            </tr>
        </table>
