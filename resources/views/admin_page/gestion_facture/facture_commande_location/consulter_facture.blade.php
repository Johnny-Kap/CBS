    ...
    <div class="block full">
        ...
        <div class="table-responsive">
            ...
            <table id="example-datatable" class="table table-striped table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    @foreach($facture_commande_location as $item)
                    <tr>
                        <td>#CL{{$item->id}}</td>
                        <td>{{$item->commande_locations->locations->vehicules->intitule}}</td>
                        <td>{{$item->commande_locations->users->name}}</td>
                        <td><a href="javascript:void(0)" class="label label-primary">{{$item->commande_locations->created_at->format('d/m/Y')}}</a></td>
