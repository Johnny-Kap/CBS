...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des factures des commandes de formation<br><small>Consulter les factures ici !</small>
            </h1>
        </div>
    </div>
    ...
    <div class="block full">
        ...
        <div class="table-responsive">
            ...
            <table id="example-datatable" class="table table-striped table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    @foreach($facture_commande_formation as $item)
                    <tr>
                        <td>#CF{{$item->id}}</td>
                        <td>{{$item->commande_formations->formations->theme}}</td>
                        <td>{{$item->commande_formations->users->name}}</td>
                        <td><a href="javascript:void(0)" class="label label-primary">{{$item->commande_formations->created_at->format('d/m/Y')}}</a></td>
