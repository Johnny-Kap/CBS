    ...
    <div class="table-section bill-tbl w-100 mt-10">
        <table class="table w-100 mt-10">
            ...
            <tr>
                ...
                <td>
                    <div class="box-text">
                        <p>Nom(s) : {{$facture->commande_formations->users->name}}</p>
                        <p>Prénom(s): {{$facture->commande_formations->users->prenom}}</p>
                        <p>Adresse : {{$facture->commande_formations->users->adresse}}</p>
                        <p>Email : {{$facture->commande_formations->users->email}}</p>
                        <p>Contact : {{$facture->commande_formations->users->tel}}</p>
                    </div>
                </td>
            </tr>
        </table>
