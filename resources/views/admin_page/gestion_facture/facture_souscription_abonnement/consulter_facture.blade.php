...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des factures de souscriptions d'abonnement<br><small>Consulter les factures ici !</small>
            </h1>
        </div>
    </div>
    ...
    <div class="block full">
        ...
        <div class="table-responsive">
            ...
            <table id="example-datatable" class="table table-striped table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    @foreach($facture_souscription_abonnement as $item)
                    <tr>
                        <td>#SA{{$item->id}}</td>
                        <td>{{$item->souscription_abonnements->abonnements->intitule}}</td>
                        <td>{{$item->souscription_abonnements->users->name}}</td>
                        <td><a href="javascript:void(0)" class="label label-primary">{{$item->souscription_abonnements->created_at->format('d/m/Y')}}</a></td>
                    ...
                    <div class="modal fade" id="pages_edit_{{$item->id}}" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <form action="{{route('facture.souscription_abonnement.generer')}}" method="get">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="booking-info pay-amount">
                                                    <h3>Voulez-vous vraiment générer la facture de cette souscription d'abonnement ?</h3>
