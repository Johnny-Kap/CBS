    ...
    <div class="table-section bill-tbl w-100 mt-10">
        <table class="table w-100 mt-10">
            ...
            <tr>
                ...
                <td>
                    <div class="box-text">
                        <p>Nom de l'entreprise : {{$facture->commande_locations->users->name}}</p>
                        <p>BP: {{$facture->commande_locations->users->boite_postale}}</p>
                        <p>Adresse : {{$facture->commande_locations->users->adresse}}</p>
                        <p>Email : {{$facture->commande_locations->users->email}}</p>
                        <p>Tel : {{$facture->commande_locations->users->tel}}</p>
                        <p>SIRET : {{$facture->commande_locations->users->siret}}</p>
                        <p>SIREN : {{$facture->commande_locations->users->siren}}</p>
                    </div>
                </td>
            </tr>
        </table>
