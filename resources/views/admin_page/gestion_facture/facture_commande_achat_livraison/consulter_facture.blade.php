...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des factures de commande d'achat et livraison de panier<br><small>Consulter les factures ici !</small>
            </h1>
        </div>
    </div>
    ...
    <div class="block full">
        ...
        <div class="table-responsive">
            ...
            <table id="example-datatable" class="table table-striped table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    @foreach($facture_commande_achat_livraison as $item)
                    <tr>
                        <td>#CALP{{$item->id}}</td>
                        <td>{{$item->achat_livraisons->type_prestation}}</td>
                        <td>{{$item->achat_livraisons->users->name}}</td>
                        <td><a href="javascript:void(0)" class="label label-primary">{{$item->achat_livraisons->created_at->format('d/m/Y')}}</a></td>
                    ...
                    <div class="modal fade" id="pages_edit_{{$item->id}}" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <form action="{{route('facture.commande_achat_livraison_panier.generer')}}" method="get">
                                    @csrf
