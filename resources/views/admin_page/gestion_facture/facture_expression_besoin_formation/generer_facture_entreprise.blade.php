    ...
    <div class="table-section bill-tbl w-100 mt-10">
        <table class="table w-100 mt-10">
            ...
            <tr>
                ...
                <td>
                    <div class="box-text">
                        <p>Nom de l'entreprise : {{$facture->expressions_besoin_formation->users->name}}</p>
                        <p>BP: {{$facture->expressions_besoin_formation->users->boite_postale}}</p>
                        <p>Adresse : {{$facture->expressions_besoin_formation->users->adresse}}</p>
                        <p>Email : {{$facture->expressions_besoin_formation->users->email}}</p>
                        <p>Tel : {{$facture->expressions_besoin_formation->users->tel}}</p>
                        <p>SIRET : {{$facture->expressions_besoin_formation->users->siret}}</p>
                        <p>SIREN : {{$facture->expressions_besoin_formation->users->siren}}</p>
                    </div>
                </td>
            </tr>
        </table>
