...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des factures des commandes de besoin de formation<br><small>Consulter les factures ici !</small>
            </h1>
        </div>
    </div>
    ...
    <div class="block full">
        ...
        <div class="table-responsive">
            ...
            <table id="example-datatable" class="table table-striped table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    @foreach($facture_expression_besoin_formation as $item)
                    <tr>
                        <td>#CEBF{{$item->id}}</td>
                        <td>{{$item->expressions_besoin_formation->theme}}</td>
                        <td>{{$item->expressions_besoin_formation->users->name}}</td>
                        <td><a href="javascript:void(0)" class="label label-primary">{{$item->expressions_besoin_formation->created_at->format('d/m/Y')}}</a></td>
                    ...
                    <div class="modal fade" id="pages_edit_{{$item->id}}" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <form action="{{route('facture.expression_besoin_formation.generer')}}" method="get">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="booking-info pay-amount">
                                                    <h3>Voulez-vous vraiment générer créer la facture de cette commande ?</h3>
