...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des achats et livraison des paniers en attente de validation<br><small>Consulter les ici !</small>
            </h1>
        </div>
    </div>
    ...
    <div class="block">
        ...
        <div class="table-responsive">
            ...
            <table id="general-table" class="table table-striped table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    @foreach($achat_livraison_attente as $item)
                    <tr>
    ...
    let table = new DataTable('#general-table', {
        ...
        layout: {
            topStart: {
                buttons: [{
                        extend: 'pdf',
                        title: 'Liste des commandes d\'achat et livraison en attente de validation',
                        exportOptions: {
                            columns: ':visible'
                        }
                    },
