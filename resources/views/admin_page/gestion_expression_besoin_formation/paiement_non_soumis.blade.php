...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des expression du besoin de formation n'ayant pas recu de paiement<br><small>Consulter les ici !</small>
            </h1>
        </div>
    </div>
    ...
    let table = new DataTable('#general-table', {
        ...
        layout: {
            topStart: {
                buttons: [{
                        extend: 'pdf',
                        title: 'Liste des commandes des expressions de besoin de formation avec non paiement soumis',
                        exportOptions: {
                            columns: ':visible'
                        }
                    },
