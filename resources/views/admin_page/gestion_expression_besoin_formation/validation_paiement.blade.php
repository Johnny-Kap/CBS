    ...
    <div class="block">
        ...
        <div class="table-responsive">
            ...
            <table id="general-table" class="table table-striped table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    @foreach($expression_besoin_validation_paiement as $item)
                    <tr>
                    ...
                    <div class="modal fade" id="pages_edit_{{$item->id}}" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <form action="{{route('expression.besoin.paiement.valide')}}" method="post">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="booking-info pay-amount">
                                                    <img style="width: 25rem; height: 50rem;" src="{{Storage::url($item->photo_paiement)}}" alt="">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="booking-info pay-amount">
    ...
    let table = new DataTable('#general-table', {
        ...
        layout: {
            topStart: {
                buttons: [{
                        extend: 'pdf',
                        title: 'Liste des commandes des expressions de besoin de formation en attente de validation de paiement',
                        exportOptions: {
                            columns: ':visible'
                        }
                    },
