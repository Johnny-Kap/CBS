                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group btn-group-xs">
                                <button class="btn btn-default" title="Modifier" type="button" data-toggle="modal" data-target="#pages_edit_{{$item->id}}"><i class="fa fa-pencil-square-o" title="Modifier"></i></button>
                    ...
                    <div class="modal fade" id="pages_edit_{{$item->id}}" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <form action="{{route('mode_paiement.edit')}}" method="post">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="booking-info pay-amount">
                                                    ...
                                                    <input type="hidden" name="mode_paiement_id" value="{{$item->id}}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
