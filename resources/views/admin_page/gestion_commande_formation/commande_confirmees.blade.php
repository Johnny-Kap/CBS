...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des commandes de formation confirmées<br><small>Consulter les ici !</small>
            </h1>
        </div>
    </div>
                    ...
                    <div class="modal fade" id="pages_edit" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <form action="{{route('facture.commande_formation.add')}}" method="post">
                                    @csrf
    ...
    let table = new DataTable('#general-table', {
        ...
        layout: {
            topStart: {
                buttons: [{
                        extend: 'pdf',
                        title: 'Liste des commandes de formation confirmées',
                        exportOptions: {
                            columns: ':visible'
                        }
                    },
