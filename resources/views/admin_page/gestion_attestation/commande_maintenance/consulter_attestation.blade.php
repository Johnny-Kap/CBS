...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des attestations de service des commandes de maintenance<br><small>Consulter les attestations ici !</small>
            </h1>
        </div>
    </div>
                    ...
                    <div class="modal fade" id="pages_edit_{{$item->id}}" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <form action="{{route('commande_maintenance.attestation_service.generer')}}" method="get">
                                    @csrf
