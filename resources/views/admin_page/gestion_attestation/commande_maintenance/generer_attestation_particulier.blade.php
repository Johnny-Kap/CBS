...
<body>
    ...
    <table class="info-table">
        <tr>
            <td>
                ...
                {{$attestation->commandes->users->name}} {{$attestation->commandes->users->prenom}}
            </td>
        </tr>
        <tr>
            <td>
                ...
                {{$attestation->commandes->marque_vehicule}}
            </td>
        </tr>
        <tr>
            <td>
    ...
    <div class="signature-section" style="margin-top: 50px;">
        ...
        <div>
            <p>
                AGENT {{$attestation->commandes->users->name}} {{$attestation->commandes->users->prenom}}
            </p>
            <p>
