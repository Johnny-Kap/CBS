...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des attestations de service des commandes de location<br><small>Consulter les attestations ici !</small>
            </h1>
        </div>
    </div>
        ...
        <div class="table-responsive">
            ...
            <table id="example-datatable" class="table table-striped table-vcenter table-condensed table-bordered">
                <thead>
                    <tr>
                        <th>N° Attestation</th>
                        <th>N° Commande de location</th>
                        <th>Commandé par</th>
                        <th>Date de commande</th>
                        <th style="width: 150px;" class="text-center">Générer attestation</th>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="form-header text-start mb-0">
                                        <h4 class="mb-0 text-dark fw-bold">Générer l'attestation N° {{$item->id}}</h4>
                                    </div>
                                </div>
                                <form action="{{route('commande_location.attestation_service.generer')}}" method="get">
                                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="booking-info pay-amount">
                                                    ...
                                                    <input type="hidden" name="attestation_id" value="{{$item->id}}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
