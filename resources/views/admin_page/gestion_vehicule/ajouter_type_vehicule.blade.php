...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-notes_2"></i>Gestion des types de véhicules<br><small>Ajouter des types de véhicules</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li><a href="{{route('type_vehicule.consulter')}}"><b>CONSULTER LES TYPES DE VEHICULE</b></a></li>
    </ul>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="block">
                ...
                <form action="{{route('type_vehicule.add')}}" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                    @csrf
