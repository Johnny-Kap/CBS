...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Marques de véhicule<br><small>Consulter les ici !</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li><a href="{{route('marque.ajouter')}}"><b>AJOUTER UNE MARQUE DE VEHICULE</b></a></li>
    </ul>
                    ...
                    <div class="modal fade" id="pages_edit_{{$item->id}}" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <form action="{{route('marque.edit')}}" method="post">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="booking-info pay-amount">
                                                    ...
                                                    <input type="hidden" name="marque_id" value="{{$item->id}}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
