...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Gestion des commande de maintenance en attente de validation<br><small>Consulter les ici !</small>
            </h1>
        </div>
    </div>
                    ...
                    <div class="modal fade" id="pages_edit_{{$item->id}}" role="dialog">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                ...
                                <form action="{{route('commande_maintenance.validation.etat')}}" method="post">
                                    @csrf
    ...
    let table = new DataTable('#general-table', {
        ...
        layout: {
            topStart: {
                buttons: [{
                        extend: 'pdf',
                        title: 'Liste des commandes de maintenance en attente de validation',
                        exportOptions: {
                            columns: ':visible'
                        }
                    },
